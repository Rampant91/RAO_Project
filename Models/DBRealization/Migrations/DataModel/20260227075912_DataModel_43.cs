        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryPackageType = table.Column<string>(type: "VARCHAR(32)", maxLength: 32, nullable: true),
                    PrimaryPackageNum = table.Column<string>(type: "VARCHAR(16)", maxLength: 16, nullable: true),
                    ClassRao = table.Column<short>(type: "SMALLINT", nullable: false),
