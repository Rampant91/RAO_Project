...
public class TableDataMain23
{
    ...
    [JsonProperty("g4")] public string ProjectVolume { get; set; }

    //"Разрешено к размещению", "код РАО", "5"
    [JsonProperty("g5")] public string CodeRAO { get; set; }

    //"Разрешено к размещению", "объем, куб. м", "6"
    [JsonProperty("g6")] public string Volume { get; set; }

    //"Разрешено к размещению", "масса, т", "7"
    [JsonProperty("g7")] public string Mass { get; set; }

    //"Разрешено к размещению", "количество ОЗИИИ, шт", "8"
    [JsonProperty("g8")] public string QuantityOZIII { get; set; }

    //"Разрешено к размещению", "суммарная активность, Бк", "9"
    [JsonProperty("g9")] public string SummaryActivity { get; set; }

    //"Наименование и реквизиты документа на размещение РАО", "номер", "10"
    [JsonProperty("g10")] public string DocumentNumber { get; set; }

    //"Наименование и реквизиты документа на размещение РАО", "дата", "11"
    [JsonProperty("g11")] public string DocumentDate { get; set; }

    //"Наименование и реквизиты документа на размещение РАО", "срок действия", "12"
    [JsonProperty("g12")] public string ExpirationDate { get; set; }

    //"Наименование и реквизиты документа на размещение РАО", "наименование документа", "13"
    [JsonProperty("g13")] public string DocumentName { get; set; }
}