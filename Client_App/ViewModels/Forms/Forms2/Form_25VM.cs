...
public class Form_25VM : BaseFormVM
{
    public override string FormType => "2.5";

    #region Constructors

    public Form_25VM() { }

    public Form_25VM(Report report) : base(report) { }

    public Form_25VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows25);
