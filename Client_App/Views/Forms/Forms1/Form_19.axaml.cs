...
public partial class Form_19 : BaseWindow<Form_19VM>
{
    //private Form_19VM _vm = null!;
    ...
    {
        InitializeComponent();
        DataContext = new Form_19VM();
        Show();
    }

    public Form_19(Form_19VM vm)
    {
        InitializeComponent();
        DataContext = vm;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_19));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_19VM)DataContext);
    ...
    {
        if (DataContext is not Form_19VM vm)
            return;
    ...
    private async void OnStandardClosing(object? sender, CancelEventArgs args)
    {
        ...
        _isCloseConfirmed = true; // ����� ������� �� ����������� ������� ����� �������� �� _isCloseConfirmed,
                                  // ���� true, �� ���� ���������,
                                  // ���� false, �� �� ���������
        if (DataContext is not Form_19VM vm) return;
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_19VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_19VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
        List<Form> formToDeleteList = [];
        var lst = vm.Report[vm.FormType].ToList<Form19>();
