...
public class Form14 : Form1
{
    ...
    public RamAccess<byte?> Sort
    {
        get
        {
            ...
            {
                ((RamAccess<byte?>)value).SyncFromStorage(Sort_DB);
    ...
    {
        if (otherForm is not Form14 formToCompare) return false;
    ...
    public override void ContributeToContentFingerprint(Models.Comparers.FormContent.ContentFingerprintSink sink)
    {
        ...
        sink.AddRaw(nameof(Sort_DB), Sort_DB);
