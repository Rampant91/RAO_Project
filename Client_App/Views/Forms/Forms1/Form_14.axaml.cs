...
public partial class Form_14 : BaseWindow<Form_14VM>
{
    ...
    {
        InitializeComponent();
        DataContext = new Form_14VM();
        Show();
    }

    public Form_14(Form_14VM vm)
    {
        InitializeComponent();
        DataContext = vm;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_14));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_14VM)DataContext);
    ...
    {
        if (DataContext is not Form_14VM vm)
            return;
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_14VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_14VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
