        ...
        if (!repsWithForm1Exist)
        {
            ...
            var answer = await Dispatcher.UIThread.InvokeAsync(() => MessageBox.Avalonia.MessageBoxManager
                .GetMessageBoxCustomWindow(new MessageBoxCustomParams
                {
                    ...
                    ContentMessage = "В текущей базе данных отсутствует формы 1.X для проверяемой организации." +
                                     $"{Environment.NewLine}Можете выбрать файл базы данных, содержащий формы 1.X для данной организации " +
