...
public class TableDataMain22
{
    ...
    [JsonProperty("g6")] public string PackQuantity { get; set; }

    //"null-7", "Код РАО", "7"
    [JsonProperty("g7")] public string CodeRAO { get; set; }

    //"null-8", "Статус РАО", "8"
    [JsonProperty("g8")] public string StatusRAO { get; set; }

    //"Объем, куб. м", "РАО без упаковки", "9"
    [JsonProperty("g9")] public string VolumeOutOfPack { get; set; }

    //"Объем, куб. м", "РАО с упаковкой", "10"
    [JsonProperty("g10")] public string VolumeInPack { get; set; }

    //"Масса, т", "РАО без упаковки (нетто)", "11"
    [JsonProperty("g11")] public string MassOutOfPack { get; set; }

    //"Масса, т", "РАО с упаковкой (брутто)", "12"
    [JsonProperty("g12")] public string MassInPack { get; set; }

    //"null-13", "Количество ОЗИИИ, шт", "13"
    [JsonProperty("g13")] public string QuantityOZIII { get; set; }

    //"Суммарная активность, Бк", "тритий", "14"
    [JsonProperty("g14")] public string TritiumActivity { get; set; }
    ...
    [JsonProperty("g16")] public string AlphaActivity { get; set; }

    //"Суммарная активность, Бк", "трансурановые радионуклиды", "17"
    [JsonProperty("g19")] public string TransuraniumActivity { get; set; }

    //"null-18", "Основные радионуклиды", "18"
    [JsonProperty("g20")] public string MainRadionuclids { get; set; }
