...
internal static partial class TransferReceiveTestCases
{
    private static IEnumerable<TransferReceiveTestCase> ClosestMatchCases()
    {
        ...
        yield return H04_EmptySerial_QuantityHighlightFalse();
    ...
    /// <summary>
    /// H04. Пустые серии: qty в подсветке всегда false (QuantityMatchesForClosest).
    /// </summary>
    private static TransferReceiveTestCase H04_EmptySerial_QuantityHighlightFalse() => new()
    {
        Name = "H04. Пустые серии — Quantity в closest красный.",
        OurOkpo = DefaultOurOkpo,
