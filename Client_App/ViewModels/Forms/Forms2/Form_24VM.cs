...
public class Form_24VM : BaseFormVM
{
    public override string FormType => "2.4";

    #region Constructors

    public Form_24VM() { }

    public Form_24VM(Report report) : base(report) { }

    public Form_24VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows24);
