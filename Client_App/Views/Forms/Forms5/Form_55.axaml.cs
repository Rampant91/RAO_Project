...
public partial class Form_55 : BaseWindow<Form_55VM>
{
    private readonly Form_55VM _vm = null!;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_55));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_55VM)DataContext);
    ...
    {
        if (DataContext is not Form_55VM vm)
            return;
    ...
    private async void OnStandardClosing(object? sender, CancelEventArgs args)
    {
        ...
        _isCloseConfirmed = true; // ����� ������� �� ����������� ������� ����� �������� �� _isCloseConfirmed,
                                  // ���� true, �� ���� ���������,
                                  // ���� false, �� �� ���������
        if (DataContext is not Form_55VM vm) return;
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_55VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_55VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
        List<Form> formToDeleteList = [];
        var lst = vm.Report[vm.FormType].ToList<Form55>();
        foreach (var form in lst)
        {
            if (string.IsNullOrWhiteSpace(form.Name_DB)
                && string.IsNullOrWhiteSpace(form.OperationCode_DB)
