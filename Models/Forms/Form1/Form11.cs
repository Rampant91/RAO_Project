...
public class Form11 : Form1
{
    ...
    public RamAccess<string> Type
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(Type_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<float?> SignedServicePeriod
    {
        get
        {
            ...
            {
                ((RamAccess<float?>)value).SyncFromStorage(SignedServicePeriod_DB);
    ...
    public void ExcelGetRow(ExcelWorksheet worksheet, int row)
    {
        ...
        SignedServicePeriod_DB = float.TryParse(RemoveExcelFormulaPrefix(Convert.ToString(worksheet.Cells[row, 13].Value)), out var floatValue) ? floatValue : null;
    ...
    public override bool IsContentEqual(Form otherForm)
    {
        ...
        return FormTextEquality.Equals(OperationCode_DB, formToCompare.OperationCode_DB)
               ...
               && FormDoubleEquality.Equals(SignedServicePeriod_DB, formToCompare.SignedServicePeriod_DB)
    ...
    public override void ContributeToContentFingerprint(Models.Comparers.FormContent.ContentFingerprintSink sink)
    {
        ...
        sink.AddFloat(nameof(SignedServicePeriod_DB), SignedServicePeriod_DB);
