...
namespace Client_App.Controls.Support.RenderDataGridRow
{
    public class Form2
    {
        ...
        private static Control Get1(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 12, "BetaGammaActivityIn", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 13, "AlphaActivityIn", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 14, "TransuraniumActivityIn", scp, TopName));
            ...
            stck.Children.Add(Get1Row(1, Row, 21, "BetaGammaActivityOut", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 22, "AlphaActivityOut", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 23, "TransuraniumActivityOut", scp, TopName));
        ...
        private static Control Get8(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 1, "NumberInOrder", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 2, "WasteSourceName", scp, TopName));
            ...
            stck.Children.Add(Get1Row(1, Row, 8, "PermissionNumber", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 9, "PermissionDocumentName", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 10, "PermissionIssueDate", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 11, "ValidBegin", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 12, "ValidThru", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 13, "PermissionNumber1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 14, "PermissionDocumentName1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 15, "PermissionIssueDate1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 16, "ValidBegin1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 17, "ValidThru1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 18, "PermissionNumber2", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 19, "PermissionDocumentName2", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 20, "PermissionIssueDate2", scp, TopName));
