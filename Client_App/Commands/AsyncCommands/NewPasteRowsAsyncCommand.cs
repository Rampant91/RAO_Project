        ...
        for (var i = 0; i < parsedRows.Length && i + start < Storage.Rows.Count; i++)
        {
            switch (FormType)
            {
                ...
                case "1.5":
                {
                    ...
                    form15.OperationCode.Value = parsedRows[i][1] is not "41" ? parsedRows[i][1] : string.Empty;
                ...
                case "1.6":
                {
                    ...
                    form16.OperationCode.Value = parsedRows[i][1] is not "41" ? parsedRows[i][1] : string.Empty;
