...
namespace Client_App.Controls.Support.RenderDataGridRow
{
    public class Form2
    {
        ...
        private static Control Get0(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 1, "SubjectRF", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 2, "JurLico", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 3, "ShortJurLico", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "JurLicoAddress", scp, TopName));
        ...
        private static Control Get2(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 4, "PackName", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 5, "PackType", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 6, "PackQuantity", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 7, "CodeRAO", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 8, "StatusRAO", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 9, "VolumeOutOfPack", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 10, "VolumeInPack", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 11, "MassOutOfPack", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 12, "MassInPack", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 13, "QuantityOZIII", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 14, "TritiumActivity", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 15, "BetaGammaActivity", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 16, "AlphaActivity", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 17, "TransuraniumActivity", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 18, "MainRadionuclids", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 19, "Subsidy", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 20, "FcpNumber", scp, TopName));
        ...
        private static Control Get3(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 2, "StoragePlaceName", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 3, "StoragePlaceCode", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "ProjectVolume", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 5, "CodeRAO", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 6, "Volume", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 7, "Mass", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 8, "QuantityOZIII", scp, TopName));
            ...
            stck.Children.Add(Get1Row(2, Row, 12, "ExpirationDate", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 13, "DocumentName", scp, TopName));
        ...
        private static Control Get4(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 1, "NumberInOrder", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 2, "CodeOYAT", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 3, "FcpNumber", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "MassCreated", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 5, "QuantityCreated", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 6, "MassFromAnothers", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 7, "QuantityFromAnothers", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 8, "MassFromAnothersImported", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 9, "QuantityFromAnothersImported", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 10, "MassAnotherReasons", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 11, "QuantityAnotherReasons", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 12, "MassTransferredToAnother", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 13, "QuantityTransferredToAnother", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 14, "MassRefined", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 15, "QuantityRefined", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 16, "MassRemovedFromAccount", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 17, "QuantityRemovedFromAccount", scp, TopName));
        ...
        private static Control Get5(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 5, "FcpNumber", scp, TopName));
            ...
            stck.Children.Add(Get1Row(2, Row, 9, "AlphaActivity", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 10, "BetaGammaActivity", scp, TopName));
        ...
        private static Control Get6(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 3, "ControlledAreaName", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 4, "SupposedWasteSource", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 5, "DistanceToWasteSource", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 6, "TestDepth", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 7, "RadionuclidName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 8, "AverageYearConcentration", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 9, "SourcesQuantity", scp, TopName));
        ...
        private static Control Get7(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 1, "NumberInOrder", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 2, "ObservedSourceNumber", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 3, "RadionuclidName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "AllowedWasteValue", scp, TopName));
            stck.Children.Add(Get1Row(4, Row, 5, "FactedWasteValue", scp, TopName));
            stck.Children.Add(Get1Row(4, Row, 6, "WasteOutbreakPreviousYear", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 7, "PermissionNumber", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 8, "PermissionIssueDate", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 9, "PermissionDocumentName", scp, TopName));
        ...
        private static Control Get8(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 3, "WasteRecieverName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "RecieverTypeCode", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 5, "PoolDistrictName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 6, "AllowedWasteRemovalVolume", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 7, "RemovedWasteVolume", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 8, "PermissionNumber", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 9, "PermissionDocumentName", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 10, "PermissionIssueDate", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 11, "ValidBegin", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 12, "ValidThru", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 13, "PermissionNumber1", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 14, "PermissionDocumentName1", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 15, "PermissionIssueDate1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 16, "ValidBegin1", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 17, "ValidThru1", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 18, "PermissionNumber2", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 19, "PermissionDocumentName2", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 20, "PermissionIssueDate2", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 21, "ValidBegin2", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 22, "ValidThru2", scp, TopName));
        ...
        private static Control Get9(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 1, "NumberInOrder", scp, TopName));
            stck.Children.Add(Get1Row(3, Row, 2, "WasteSourceName", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 3, "RadionuclidName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "AllowedActivity", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 5, "FactedActivity", scp, TopName));
        ...
        private static Control Get10(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 3, "PlotName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 4, "PlotKadastrNumber", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 5, "PlotCode", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 6, "InfectedArea", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 7, "AvgGammaRaysDosePower", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 8, "MaxGammaRaysDosePower", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 9, "WasteDensityAlpha", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 10, "WasteDensityBeta", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 11, "FcpNumber", scp, TopName));
        ...
        private static Control Get11(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(1, Row, 1, "NumberInOrder", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 2, "PlotName", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 3, "PlotKadastrNumber", scp, TopName));
            stck.Children.Add(Get1Row(1, Row, 4, "PlotCode", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 5, "InfectedArea", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 6, "Radionuclids", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 7, "SpecificActivityOfPlot", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 8, "SpecificActivityOfLiquidPart", scp, TopName));
            stck.Children.Add(Get1Row(2, Row, 9, "SpecificActivityOfDensePart", scp, TopName));
        ...
        private static Control Get12(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(2, Row, 3, "ObjectTypeCode", scp, TopName));
