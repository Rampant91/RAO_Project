...
namespace Models
{
        ...
        public bool CodeRAOout_Hidden
    {
        ...
        public int ExcelRow(ExcelWorksheet worksheet, int Row,int Column,bool Transpon=true)
        {
            ...
            worksheet.Cells[Row + (Transpon == false ? 7 : 0), Column + (Transpon == true ? 7 : 0)].Value = MassIn_DB.Replace(" ", "") == "-" || MassIn_DB.Replace(" ", "") == "" ? MassIn_DB : Convert.ToDouble(MassIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 8 : 0), Column + (Transpon == true ? 8 : 0)].Value = QuantityIn_DB;
            worksheet.Cells[Row + (Transpon == false ? 9 : 0), Column + (Transpon == true ? 9 : 0)].Value = TritiumActivityIn_DB.Replace(" ", "") == "-" || TritiumActivityIn_DB.Replace(" ", "") == "" ? TritiumActivityIn_DB : Convert.ToDouble(TritiumActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 10 : 0), Column + (Transpon == true ? 10 : 0)].Value = BetaGammaActivityIn_DB.Replace(" ", "") == "-" || BetaGammaActivityIn_DB.Replace(" ", "") == "" ? BetaGammaActivityIn_DB : Convert.ToDouble(BetaGammaActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 11 : 0), Column + (Transpon == true ? 11 : 0)].Value = AlphaActivityIn_DB.Replace(" ", "") == "-" || AlphaActivityIn_DB.Replace(" ", "") == "" ? AlphaActivityIn_DB : Convert.ToDouble(AlphaActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 12 : 0), Column + (Transpon == true ? 12 : 0)].Value = TransuraniumActivityIn_DB.Replace(" ", "") == "-" || TransuraniumActivityIn_DB.Replace(" ", "") == "" ? TransuraniumActivityIn_DB : Convert.ToDouble(TritiumActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            ...
            worksheet.Cells[Row + (Transpon == false ? 15 : 0), Column + (Transpon == true ? 15 : 0)].Value = VolumeOut_DB.Replace(" ", "") == "-" || VolumeOut_DB.Replace(" ", "") == "" ? VolumeOut_DB : Convert.ToDouble(VolumeOut_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 16 : 0), Column + (Transpon == true ? 16 : 0)].Value = MassOut_DB.Replace(" ", "") == "-" || MassOut_DB.Replace(" ", "") == "" ? MassOut_DB : Convert.ToDouble(MassOut_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 17 : 0), Column + (Transpon == true ? 17 : 0)].Value = QuantityOZIIIout_DB;
            worksheet.Cells[Row + (Transpon == false ? 18 : 0), Column + (Transpon == true ? 18 : 0)].Value = TritiumActivityOut_DB.Replace(" ", "") == "-" || TritiumActivityOut_DB.Replace(" ", "") == "" ? TritiumActivityOut_DB : Convert.ToDouble(TritiumActivityOut_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 19 : 0), Column + (Transpon == true ? 19 : 0)].Value = BetaGammaActivityOut_DB.Replace(" ", "") == "-" || BetaGammaActivityOut_DB.Replace(" ", "") == "" ? BetaGammaActivityOut_DB : Convert.ToDouble(BetaGammaActivityOut_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 20 : 0), Column + (Transpon == true ? 20 : 0)].Value = AlphaActivityOut_DB.Replace(" ", "") == "-" || AlphaActivityOut_DB.Replace(" ", "") == "" ? AlphaActivityOut_DB: Convert.ToDouble(AlphaActivityOut_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 21 : 0), Column + (Transpon == true ? 21 : 0)].Value = TransuraniumActivityOut_DB.Replace(" ", "") == "-" || TransuraniumActivityOut_DB.Replace(" ", "") == "" ? TransuraniumActivityOut_DB : Convert.ToDouble(TransuraniumActivityOut_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
