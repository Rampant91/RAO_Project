...
namespace Client_App.Controls.Support.RenderDataGridHeader
{
    public class Form1
    {
        ...
        private static List<Row> Get5()
        {
            ...
            //        .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,9
            //));
            stck.Add(Get5Header(new double[8] { 1.1, 1, 1, 2, 1, 1, 2, 7.1 }, 3, new string[8] {
            ...
            //stck.Add(Get2Header(1.5, 11,
            //    ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("PropertyCode")
            //        .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,10
            //));
            //stck.Add(Get2Header(1, 12,
            //    ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("Owner")
            //        .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,11
            //));
            stck.Add(Get5Header(new double[3] { 1.5, 1, 2.5 }, 5, new string[3] {
                ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("PropertyCode").GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,
                ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("Owner").GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,
                "Право собственности на ИОУ" }, true, 11));
            //stck.Add(Get2Header(1, 13,
            ...
            //        .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,19
            //));
            stck.Add(Get5Header(new double[4] { 2, 1, 1.5, 4.5 }, 8, new string[4] {
            ...
            //        .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,20
            //));
            stck.Add(Get5Header(new double[3] { 1.5, 1, 2.5 }, 9, new string[3] {
                ...
                "Право собственности на ИОУ" }, true, 21));
            //stck.Add(Get5Header(2.1, 22,
            //    ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("RefineOrSortRAOCode")
            //        .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name,21
            //));
            stck.Add(Get5Header(new double[1] { 1 }, 10, new string[1] { ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("RefineOrSortRAOCode")
            ...
            stck.Add(Get5Header(new double[1] { 1 }, 11, new string[1] { ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("Subsidy")
                    .GetCustomAttributes(typeof(Form_PropertyAttribute), false).First()).Name }, false, 24));
            ...
            //));
            stck.Add(Get5Header(new double[1] { 1 }, 12, new string[1] { ((Form_PropertyAttribute) Type.GetType("Models.Form15,Models").GetProperty("FcpNumber")
