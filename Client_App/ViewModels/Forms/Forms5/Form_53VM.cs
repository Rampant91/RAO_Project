...
{
    public class Form_53VM : BaseFormVM
    {
        public override string FormType => "5.3";

        #region Constructors

        public Form_53VM() { }

        public Form_53VM(Report report) : base(report) { }

        public Form_53VM(in Reports reps)
        {
        ...
        public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows53);
