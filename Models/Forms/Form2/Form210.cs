...
namespace Models
{
    ...
    public class Form210 : Abstracts.Form2
    {
        ...
        public int ExcelRow(ExcelWorksheet worksheet, int Row,int Column,bool Transpon=true)
        {
            ...
            worksheet.Cells[Row + (Transpon == false ? 4 : 0), Column + (Transpon == true ? 4 : 0)].Value = InfectedArea_DB.Replace(" ", "") == "-" || InfectedArea_DB.Replace(" ", "") == "" || InfectedArea_DB.Equals("без упаковки") || InfectedArea_DB.Equals("прим.") ? InfectedArea_DB : Convert.ToDouble(InfectedArea_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 5 : 0), Column + (Transpon == true ? 5 : 0)].Value = AvgGammaRaysDosePower_DB.Replace(" ", "") == "-" || AvgGammaRaysDosePower_DB.Replace(" ", "") == "" || AvgGammaRaysDosePower_DB.Equals("без упаковки") || AvgGammaRaysDosePower_DB.Equals("прим.") ? AvgGammaRaysDosePower_DB : Convert.ToDouble(AvgGammaRaysDosePower_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 6 : 0), Column + (Transpon == true ? 6 : 0)].Value = MaxGammaRaysDosePower_DB.Replace(" ", "") == "-" || MaxGammaRaysDosePower_DB.Replace(" ", "") == "" || MaxGammaRaysDosePower_DB.Equals("без упаковки") || MaxGammaRaysDosePower_DB.Equals("прим.") ? MaxGammaRaysDosePower_DB : Convert.ToDouble(MaxGammaRaysDosePower_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 7 : 0), Column + (Transpon == true ? 7 : 0)].Value = WasteDensityAlpha_DB.Replace(" ", "") == "-" || WasteDensityAlpha_DB.Replace(" ", "") == "" || WasteDensityAlpha_DB.Equals("без упаковки") || WasteDensityAlpha_DB.Equals("прим.") ? WasteDensityAlpha_DB : Convert.ToDouble(WasteDensityAlpha_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 8 : 0), Column + (Transpon == true ? 8 : 0)].Value = WasteDensityBeta_DB.Replace(" ", "") == "-" || WasteDensityBeta_DB.Replace(" ", "") == "" || WasteDensityBeta_DB.Equals("без упаковки") || WasteDensityBeta_DB.Equals("прим.") ? WasteDensityBeta_DB : Convert.ToDouble(WasteDensityBeta_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
