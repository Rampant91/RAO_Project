...
{
    public class Form_55VM : BaseFormVM
    {
        public override string FormType => "5.5";

        #region Constructors

        public Form_55VM() { }

        public Form_55VM(Report report) : base(report) { }

        public Form_55VM(in Reports reps)
        {
        ...
        public ICommand GenerateForm55 => new GenerateForm55AsyncCommand(this);
        public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows55);
