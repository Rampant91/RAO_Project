    ...
    public override async Task AsyncExecute(object? parameter)
    {
        ...
        foreach (var dto in dto11List)
        {
            if (lastRow == 1)
            {
                ...
                Worksheet.Cells[2, 11].Value = ConvertToExcelDate(dto.OperationDate);
                ...
                Worksheet.Cells[2, 19].Value = ConvertToExcelDate(dto.CreationDate);
                ...
                Worksheet.Cells[2, 26].Value = ConvertToExcelDate(dto.DocumentDate);
        ...
        foreach (var dto in dto15List)
        {
            if (lastRow == 1)
            {
                ...
                Worksheet.Cells[2, 16].Value = dto.Quantity is null ? "-" : dto.Quantity;
                Worksheet.Cells[2, 17].Value = ConvertToExcelDouble(dto.Activity);
                Worksheet.Cells[2, 18].Value = ConvertToExcelDate(dto.CreationDate);
                ...
                Worksheet.Cells[2, 22].Value = ConvertToExcelDate(dto.DocumentDate);
            ...
            for (var currentRow = 2; currentRow <= lastRow + 1; currentRow++)
            {
                ...
                Worksheet.Cells[currentRow, 16].Value = dto.Quantity is null ? "-" : dto.Quantity;
                Worksheet.Cells[currentRow, 17].Value = ConvertToExcelDouble(dto.Activity);
                Worksheet.Cells[currentRow, 18].Value = ConvertToExcelDate(dto.CreationDate);
                ...
                Worksheet.Cells[currentRow, 22].Value = ConvertToExcelDate(dto.DocumentDate);
