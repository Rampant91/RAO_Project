...
public class Form_26VM : BaseFormVM
{
    public override string FormType => "2.6";

    #region Constructors

    public Form_26VM() { }

    public Form_26VM(Report report) : base(report) { }

    public Form_26VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows26);
