...
public class Form57 : Form
{
    ...
    public override bool IsContentEqual(Form otherForm)
    {
        ...
        return FormTextEquality.Equals(RegNo_DB, formToCompare.RegNo_DB)
               ...
               && FormTextEquality.Equals(Recognizance_DB, formToCompare.Recognizance_DB)
               && FormTextEquality.Equals(License_DB, formToCompare.License_DB)
               && FormTextEquality.Equals(Practice_DB, formToCompare.Practice_DB)
