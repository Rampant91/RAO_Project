...
namespace Models
{
    ...
    public class Form210 : Abstracts.Form2
    {
        ...
        public int ExcelRow(ExcelWorksheet worksheet, int Row,int Column,bool Transpon=true)
        {
            ...
            worksheet.Cells[Row + (Transpon == false ? 4 : 0), Column + (Transpon == true ? 4 : 0)].Value = InfectedArea_DB.Replace(" ", "") == "-" || InfectedArea_DB.Replace(" ", "") == "" || InfectedArea_DB.ToLower() == "без упаковки" || InfectedArea_DB.ToLower() == "прим." ? InfectedArea_DB : Convert.ToDouble(InfectedArea_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 5 : 0), Column + (Transpon == true ? 5 : 0)].Value = AvgGammaRaysDosePower_DB.Replace(" ", "") == "-" || AvgGammaRaysDosePower_DB.Replace(" ", "") == "" || AvgGammaRaysDosePower_DB.ToLower() == "без упаковки" || AvgGammaRaysDosePower_DB.ToLower() == "прим." ? AvgGammaRaysDosePower_DB : Convert.ToDouble(AvgGammaRaysDosePower_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 6 : 0), Column + (Transpon == true ? 6 : 0)].Value = MaxGammaRaysDosePower_DB.Replace(" ", "") == "-" || MaxGammaRaysDosePower_DB.Replace(" ", "") == "" || MaxGammaRaysDosePower_DB.ToLower() == "без упаковки" || MaxGammaRaysDosePower_DB.ToLower() == "прим." ? MaxGammaRaysDosePower_DB : Convert.ToDouble(MaxGammaRaysDosePower_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 7 : 0), Column + (Transpon == true ? 7 : 0)].Value = WasteDensityAlpha_DB.Replace(" ", "") == "-" || WasteDensityAlpha_DB.Replace(" ", "") == "" || WasteDensityAlpha_DB.ToLower() == "без упаковки" || WasteDensityAlpha_DB.ToLower() == "прим." ? WasteDensityAlpha_DB : Convert.ToDouble(WasteDensityAlpha_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 8 : 0), Column + (Transpon == true ? 8 : 0)].Value = WasteDensityBeta_DB.Replace(" ", "") == "-" || WasteDensityBeta_DB.Replace(" ", "") == "" || WasteDensityBeta_DB.ToLower() == "без упаковки" || WasteDensityBeta_DB.ToLower() == "прим." ? WasteDensityBeta_DB : Convert.ToDouble(WasteDensityBeta_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
