...
/// </para>
/// <para>
/// Идентификаторы учётных единиц в сценариях — вымышленные (P-900, P-101, Тип-М1 и т.д.), не реальные паспорта/типы ЗРИ.
/// </para>
/// <para>
/// <b>Якорь P-900/F-001</b> — вымышленная учётная единица, стоящая на учёте с первой инвентаризации и не двигающаяся.
...
internal static partial class SnkTestCases
{
    ...
    /// <summary>op.10 — инвентаризация якоря P-900/F-001 (всегда в наличии с первой инв.).</summary>
    private static SnkTestOperationSpec Anchor(DateOnly date) =>
        Operation("10", date, "P-900", "F-001", "Тип-База", "кобальт-60", "УКТ-0");

    /// <summary>Ожидаемая строка СНК для якоря P-900/F-001.</summary>
    private static SnkStockSnapshot AnchorStock() =>
        Stock("P-900", "F-001", "Тип-База", "кобальт-60", "УКТ-0");
