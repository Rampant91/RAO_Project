...
{
    public class Form_52VM : BaseFormVM
    {
        public override string FormType => "5.2";

        #region Constructors

        public Form_52VM() { }

        public Form_52VM(Report report) : base(report) { }

        public Form_52VM(in Reports reps)
        {
        ...
        public ICommand GenerateForm52 => new GenerateForm52AsyncCommand(this);
        public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows52);
