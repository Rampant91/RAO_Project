...
public partial class ExcelExportCheckPairingOfCode41AsyncCommand
{
    ...
    private static void CreatePairingLegendSheet(ExcelPackage excelPackage)
    {
        ...
        Bullet("Тип / тип упаковки: пропущенное или лишнее тире (пробел вместо тире), а также одна опечатка в достаточно длинном обозначении (в т.ч. цифра 1 и буква I) — жёлтый; короткие пары вроде одной-двух букв так не смягчаются.");
