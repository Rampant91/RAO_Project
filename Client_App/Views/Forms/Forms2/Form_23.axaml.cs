...
public partial class Form_23 : BaseWindow<Form_23VM>
{
    private readonly Form_23VM _vm = null!;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_23));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_23VM)DataContext);
    ...
    {
        if (DataContext is not Form_23VM vm) return;
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_23VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_23VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
