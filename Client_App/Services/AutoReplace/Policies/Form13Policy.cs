...
internal static class Form13Policy
{
    public static void ApplyOperationCode(Form13 form)
    {
        ...
        switch (opCode)
        {
            ...
            case "11":
            {
                #region CreatorOKPO (9) — код ОКПО изготовителя
                ...
                #region CreationDate (10) — дата выпуска
                ...
                #region DocumentVid (14) — документ, вид
                ...
                #region DocumentNumber (15) — документ, номер
                ...
                #region DocumentDate (16) — документ, дата
