...
//  Удалить выбранный отчет у выбранной организации (вместе с входящими в него формами)
internal class DeleteFormAsyncCommand : BaseAsyncCommand
{
    public override async Task AsyncExecute(object? parameter)
    {
        ...
        switch (selectedReport.FormNum_DB)
        {
            ...
            case "1.1":
                var forms11IdToDelete = db.form_11
                    .AsNoTracking()
                    .Where(form11 => form11.ReportId == selectedReport.Id)
            ...
            case "1.2":
                var forms12IdToDelete = db.form_12
                    .AsNoTracking()
                    .Where(form12 => form12.ReportId == selectedReport.Id)
            ...
            case "1.3":
                var forms13IdToDelete = db.form_13
                    .AsNoTracking()
                    .Where(form13 => form13.ReportId == selectedReport.Id)
            ...
            case "1.4":
                var forms14IdToDelete = db.form_14
                    .AsNoTracking()
                    .Where(form14 => form14.ReportId == selectedReport.Id)
            ...
            case "1.5":
                var forms15IdToDelete = db.form_15
                    .AsNoTracking()
                    .Where(form15 => form15.ReportId == selectedReport.Id)
            ...
            case "1.6":
                var forms16IdToDelete = db.form_16
                    .AsNoTracking()
                    .Where(form16 => form16.ReportId == selectedReport.Id)
            ...
            case "1.7":
                var forms17IdToDelete = db.form_17
                    .AsNoTracking()
                    .Where(form17 => form17.ReportId == selectedReport.Id)
            ...
            case "1.8":
                var forms18IdToDelete = db.form_18
                    .AsNoTracking()
                    .Where(form18 => form18.ReportId == selectedReport.Id)
            ...
            case "1.9":
                var forms19IdToDelete = db.form_19
                    .AsNoTracking()
                    .Where(form19 => form19.ReportId == selectedReport.Id)
            ...
            case "2.1":
                var forms21IdToDelete = db.form_21
                    .AsNoTracking()
                    .Where(form21 => form21.ReportId == selectedReport.Id)
            ...
            case "2.2":
                var forms22IdToDelete = db.form_22
                    .AsNoTracking()
                    .Where(form22 => form22.ReportId == selectedReport.Id)
            ...
            case "2.3":
                var forms23IdToDelete = db.form_23
                    .AsNoTracking()
                    .Where(form23 => form23.ReportId == selectedReport.Id)
            ...
            case "2.4":
                var forms24IdToDelete = db.form_24
                    .AsNoTracking()
                    .Where(form24 => form24.ReportId == selectedReport.Id)
            ...
            case "2.5":
                var forms25IdToDelete = db.form_25
                    .AsNoTracking()
                    .Where(form25 => form25.ReportId == selectedReport.Id)
            ...
            case "2.6":
                var forms26IdToDelete = db.form_26
                    .AsNoTracking()
                    .Where(form26 => form26.ReportId == selectedReport.Id)
            ...
            case "2.7":
                var forms27IdToDelete = db.form_27
                    .AsNoTracking()
                    .Where(form27 => form27.ReportId == selectedReport.Id)
            ...
            case "2.8":
                var forms28IdToDelete = db.form_28
                    .AsNoTracking()
                    .Where(form28 => form28.ReportId == selectedReport.Id)
            ...
            case "2.9":
                var forms29IdToDelete = db.form_29
                    .AsNoTracking()
                    .Where(form29 => form29.ReportId == selectedReport.Id)
            ...
            case "2.10":
                var forms210IdToDelete = db.form_210
                    .AsNoTracking()
                    .Where(form210 => form210.ReportId == selectedReport.Id)
            ...
            case "2.11":
                var forms211IdToDelete = db.form_211
                    .AsNoTracking()
                    .Where(form211 => form211.ReportId == selectedReport.Id)
            ...
            case "2.12":
                var forms212IdToDelete = db.form_212
                    .AsNoTracking()
                    .Where(form212 => form212.ReportId == selectedReport.Id)
        ...
        var notesIdToDelete = db.notes
            .AsNoTracking()
            .Where(note => note.ReportId == selectedReport.Id)
            .Select(note => note.Id)
            .ToList();
