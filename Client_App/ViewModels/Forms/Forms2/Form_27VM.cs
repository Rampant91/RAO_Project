...
public class Form_27VM : BaseFormVM
{
    public override string FormType => "2.7";

    #region Constructors

    public Form_27VM() { }

    public Form_27VM(Report report) : base(report) { }

    public Form_27VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows27);
