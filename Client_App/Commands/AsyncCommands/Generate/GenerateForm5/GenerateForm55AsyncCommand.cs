...
{
    public class GenerateForm55AsyncCommand(BaseFormVM formVM) : BaseGenerateForm5
    {
        ...
        public override async Task AsyncExecute(object? parameter)
        {
            ...
            owner = FormWindowNames.FindOpenFormWindow("5.5");
                ...
                try
                {
                    ...
                    if (row55 != null)
                    {
                        try
                        {
                            ...
                            row55.Quantity_DB ++;
                            row55.Mass.Value = SummarizeExponentionalStrings(row55.Mass.Value, row12.Mass.Value);
                        }
                        catch (OperationCanceledException)
                        {
                            throw;
