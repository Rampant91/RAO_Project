...
[Table (name: "form_27")]
public class Form27 : Form2, ICopiable
{
    #region Constructor
    ...
    public string ConvertToTSVstring()
    {
        ...
        var str =
            ...
            $"{AllowedWasteValue.Value}\t" +
            $"{FactedWasteValue.Value}\t" +
            $"{WasteOutbreakPreviousYear.Value}";
        return str;
    }
    ...
    public void PasteParsedTSVstring(string[] parsedTSVstring)
    {
        ...
        AllowedWasteValue.Value = parsedTSVstring[2 + offset];
        FactedWasteValue.Value = parsedTSVstring[3 + offset];
        WasteOutbreakPreviousYear.Value = parsedTSVstring[4 + offset];
    }
