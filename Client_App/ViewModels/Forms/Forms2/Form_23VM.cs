...
public class Form_23VM : BaseFormVM
{
    public override string FormType => "2.3";

    #region Constructors

    public Form_23VM() { }

    public Form_23VM(Report report) : base(report) { }

    public Form_23VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows23);
