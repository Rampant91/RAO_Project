...
public partial class Form16 : Form1
{
    ...
    public RamAccess<string> CodeRAO
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(CodeRAO_DB);
    ...
    public RamAccess<string> StatusRAO  //1 digit or OKPO.
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(StatusRAO_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> QuantityOZIII
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(QuantityOZIII_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> MainRadionuclids
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(MainRadionuclids_DB);
                return (RamAccess<string>)value;
            }
    ...
    private static bool MainRadionuclids_Validation(RamAccess<string> value) => NuclidString_Validation(value);
    ...
    public RamAccess<string> TritiumActivity
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(TritiumActivity_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> BetaGammaActivity
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(BetaGammaActivity_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> AlphaActivity
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(AlphaActivity_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> TransuraniumActivity
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(TransuraniumActivity_DB);
                return (RamAccess<string>)value;
            }
    ...
    public virtual RamAccess<string> ActivityMeasurementDate
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(ActivityMeasurementDate_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> StoragePlaceName
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(StoragePlaceName_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> StoragePlaceCode //8 digits code or - .
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(StoragePlaceCode_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> RefineOrSortRAOCode //2 digits code or empty.
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(RefineOrSortRAOCode_DB);
                return (RamAccess<string>)value;
            }
    ...
    public RamAccess<string> Subsidy // 0<number<=100 or empty.
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(Subsidy_DB);
                return (RamAccess<string>)value;
            }
    ...
    [NotMapped]
    [FormProperty(true, "Договор", "номер", "28")]
    public RamAccess<string> ContractNumber
    {
        get
        {
            ...
            {
                ((RamAccess<string>)value).SyncFromStorage(ContractNumber_DB);
                return (RamAccess<string>)value;
            }
    ...
    public static int ExcelHeader(ExcelWorksheet worksheet, int row, int column, bool transpose = true)
    {
        ...
        worksheet.Cells[row + (!transpose ? 24 : 0), column + (transpose ? 24 : 0)].Value = ((FormPropertyAttribute)Type.GetType("Models.Forms.Form1.Form16,Models")?.GetProperty(nameof(ContractNumber))?.GetCustomAttributes(typeof(FormPropertyAttribute), false).First())?.Names[1];
    ...
    public override DataGridColumns GetColumnStructure(string param = "")
    {
        ...
        var contractNumberR = ((FormPropertyAttribute)typeof(Form16)
    ...
    public override bool IsContentEqual(Form otherForm)
    {
        ...
        return FormTextEquality.Equals(OperationCode_DB, formToCompare.OperationCode_DB)
               ...
               && FormDateEquality.Equals(ActivityMeasurementDate_DB, formToCompare.ActivityMeasurementDate_DB)
    ...
    public override void ContributeToContentFingerprint(Models.Comparers.FormContent.ContentFingerprintSink sink)
    {
        ...
        sink.AddDate(nameof(ActivityMeasurementDate_DB), ActivityMeasurementDate_DB);
