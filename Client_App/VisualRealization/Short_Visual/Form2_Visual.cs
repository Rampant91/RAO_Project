...
namespace Client_App.Short_Visual
{
    public class Form2_Visual
    {
        ...
        private static Control Form0_Visual(INameScope scp)
        {
            ...
            grd.PageSize = 10;
            grd.IsReadable = true;
            (((((grd.Content as Panel).Children[0] as StackPanel).Children[1] as Border).Child as ScrollViewer).Content as Panel).Height = 286;
        ...
        private static Control FormX_Visual(INameScope scp)
        {
            ...
            grd.PageSize = 10;
            grd.IsReadable = true;
            ((((grd.Content as Panel).Children[0] as StackPanel).Children[1] as Border).Child as ScrollViewer).MaxHeight = 240;
            Binding b = new Binding
            {
                Path = "SelectedItems",
                ElementName = "Form20AllDataGrid_",
