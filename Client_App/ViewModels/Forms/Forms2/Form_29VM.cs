...
public class Form_29VM : BaseFormVM
{
    ...
    public Form_29VM(Report report) : base(report) { }

    public Form_29VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows29);
