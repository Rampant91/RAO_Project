...
namespace Client_App.Controls.Support.RenderDataGridRow
{
    public class Form1
    {
        ...
        private static Control Get1(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get1Row(0.9, Row, 3, "OperationDate", scp, TopName));
            stck.Children.Add(Get1Row(2.5, Row, 4, "PassportNumber", scp, TopName));
            stck.Children.Add(Get1Row(1.5, Row, 5, "Type", scp, TopName));
            ...
            stck.Children.Add(Get1Row(2, Row, 9, "Activity", scp, TopName));
            stck.Children.Add(Get1Row(1.53, Row, 10, "CreatorOKPO", scp, TopName));
            stck.Children.Add(Get1Row(1.35, Row, 11, "CreationDate", scp, TopName));
            stck.Children.Add(Get1Row(0.9, Row, 12, "Category", scp, TopName));
            stck.Children.Add(Get1Row(0.9, Row, 13, "SignedServicePeriod", scp, TopName));
            stck.Children.Add(Get1Row(1.8, Row, 14, "PropertyCode", scp, TopName));
            stck.Children.Add(Get1Row(2.5, Row, 15, "Owner", scp, TopName));
            stck.Children.Add(Get1Row(0.9, Row, 16, "DocumentVid", scp, TopName));
            stck.Children.Add(Get1Row(1.5, Row, 17, "DocumentNumber", scp, TopName));
            stck.Children.Add(Get1Row(0.9, Row, 18, "DocumentDate", scp, TopName));
            stck.Children.Add(Get1Row(1.8, Row, 19, "ProviderOrRecieverOKPO", scp, TopName));
            stck.Children.Add(Get1Row(1.8, Row, 20, "TransporterOKPO", scp, TopName));
        ...
        private static Control Get2(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get2Row(2.5, Row, 7, "Mass", scp, TopName));
            stck.Children.Add(Get2Row(1.7, Row, 8, "CreatorOKPO", scp, TopName));
        ...
        private static Control Get3(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get3Row(1.7, Row, 13, "Owner", scp, TopName));
            stck.Children.Add(Get3Row(1, Row, 14, "DocumentVid", scp, TopName));
            stck.Children.Add(Get3Row(1.5, Row, 15, "DocumentNumber", scp, TopName));
            ...
            stck.Children.Add(Get3Row(1.5, Row, 18, "TransporterOKPO", scp, TopName));
        ...
        private static Control Get4(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get4Row(1.5, Row, 19, "TransporterOKPO", scp, TopName));
        ...
        private static Control Get5(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get5Row(4.5, Row, 4, "PassportNumber", scp, TopName));
            ...
            stck.Children.Add(Get5Row(2, Row, 9, "Activity", scp, TopName));
            ...
            stck.Children.Add(Get5Row(1.5, Row, 13, "DocumentNumber", scp, TopName));
            ...
            stck.Children.Add(Get5Row(1.5, Row, 16, "TransporterOKPO", scp, TopName));
        ...
        private static Control Get6(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get6Row(1.8, Row, 6, "Volume", scp, TopName));
            stck.Children.Add(Get6Row(1.8, Row, 7, "Mass", scp, TopName));
        ...
        private static Control Get7(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get7Row(2.6, Row, 7, "PackNumber", scp, TopName));
            ...
            stck.Children.Add(Get7Row(1.2, Row, 15, "DocumentNumber", scp, TopName));
        ...
        private static Control Get8(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get8Row(4.2, Row, 4, "IndividualNumberZHRO", scp, TopName));
        ...
        private static Control Get9(int Row, INameScope scp, string TopName)
        {
            ...
            stck.Children.Add(Get9Row(1.5, Row, 8, "Radionuclids", scp, TopName));
            //stck.Children.Add(Get9Row(1, Row, 9, "Quantity", scp, TopName));
            stck.Children.Add(Get9Row(1.5, Row, 9, "Activity", scp, TopName));
