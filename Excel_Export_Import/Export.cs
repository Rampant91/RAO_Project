...
namespace Excel_Export_Import
{
    public class Export
    {
        public List<List<Form>> ExForms { get; set; }

        public bool DoExport(string Path)
        {
        ...
        public Export(List<List<Form>> exForms)
        {
            ExForms = exForms;
        }
    }
