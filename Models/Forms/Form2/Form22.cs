...
namespace Models
{
    ...
    public class Form22 : Abstracts.Form2, IBaseColor
    {
        ...
        public int ExcelRow(ExcelWorksheet worksheet, int Row, int Column, bool Transpon = true)
        {
            ...
            worksheet.Cells[Row + (Transpon == false ? 7 : 0), Column + (Transpon == true ? 7 : 0)].Value = VolumeOutOfPack_DB.Replace(" ", "") == "-" || VolumeOutOfPack_DB.Replace(" ", "") == "" ? VolumeOutOfPack_DB : Convert.ToDouble(VolumeOutOfPack_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 8 : 0), Column + (Transpon == true ? 8 : 0)].Value = VolumeInPack_DB.Replace(" ", "") == "-" || VolumeInPack_DB.Replace(" ", "") == "" ? VolumeInPack_DB : Convert.ToDouble(VolumeInPack_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 9 : 0), Column + (Transpon == true ? 9 : 0)].Value = MassOutOfPack_DB.Replace(" ", "") == "-" || MassOutOfPack_DB.Replace(" ", "") == "" ? MassOutOfPack_DB : Convert.ToDouble(MassOutOfPack_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 10 : 0), Column + (Transpon == true ? 10 : 0)].Value = MassInPack_DB.Replace(" ", "") == "-" || MassInPack_DB.Replace(" ", "") == "" ? MassInPack_DB : Convert.ToDouble(MassInPack_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 11 : 0), Column + (Transpon == true ? 11 : 0)].Value = QuantityOZIII_DB;
            worksheet.Cells[Row + (Transpon == false ? 12 : 0), Column + (Transpon == true ? 12 : 0)].Value = TritiumActivity_DB.Replace(" ", "") == "-" || TritiumActivity_DB.Replace(" ", "") == "" ? TritiumActivity_DB : Convert.ToDouble(TritiumActivity_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 13 : 0), Column + (Transpon == true ? 13 : 0)].Value = BetaGammaActivity_DB.Replace(" ", "") == "-" || BetaGammaActivity_DB.Replace(" ", "") == "" ? BetaGammaActivity_DB : Convert.ToDouble(BetaGammaActivity_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 14 : 0), Column + (Transpon == true ? 14 : 0)].Value = AlphaActivity_DB.Replace(" ", "") == "-" || AlphaActivity_DB.Replace(" ", "") == "" ? AlphaActivity_DB : Convert.ToDouble(AlphaActivity_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 15 : 0), Column + (Transpon == true ? 15 : 0)].Value = TransuraniumActivity_DB.Replace(" ", "") == "-" || TransuraniumActivity_DB.Replace(" ", "") == "" ? TransuraniumActivity_DB : Convert.ToDouble(TransuraniumActivity_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
