...
public partial class Form_30 : BaseWindow<Form_30VM>
{
    private protected static readonly IClassicDesktopStyleApplicationLifetime Desktop =
        (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;

    private Form_30VM _vm = null!;

    public Form_30() { }

    public Form_30(Form_30VM vm)
    {
    ...
    {
        if (DataContext is not Form_30VM vm) return;
        ...
        var window = Desktop.Windows.FirstOrDefault(x => x.Name is "3.0");
        ...
        if (string.IsNullOrWhiteSpace(_vm.Storage.RegNoRep.Value)
            ...
            || !await query
                .AnyAsync(reps => reps.Master_DB.Rows30
                    .Any(form30 => form30.RegNo_DB == regNum
                                   && form30.Okpo_DB == okpo)))
        {
