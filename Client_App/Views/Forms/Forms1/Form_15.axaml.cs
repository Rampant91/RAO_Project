...
public partial class Form_15 : BaseWindow<Form_15VM>
{
    private readonly Form_15VM _vm = null!;
    ...
    public Form_15()
    {
        InitializeComponent();
        _vm = new Form_15VM();
        DataContext = new Form_15VM();
        Show();
    }

    public Form_15(Form_15VM vm)
    {
        InitializeComponent();
        DataContext = vm;
        _vm = vm;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_15));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_15VM)DataContext);
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_15VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_15VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
        List<Form> formToDeleteList = [];
        var lst = vm.Report[vm.FormType].ToList<Form15>();
