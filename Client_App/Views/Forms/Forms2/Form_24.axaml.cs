...
public partial class Form_24 : BaseWindow<Form_24VM>
{
    private readonly Form_24VM _vm = null!;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_24));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_24VM)DataContext);
    ...
    {
        if (DataContext is not Form_24VM vm) return;
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_24VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_24VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
        List<Form> formToDeleteList = [];
        var lst = vm.Report[vm.FormType].ToList<Form24>();
