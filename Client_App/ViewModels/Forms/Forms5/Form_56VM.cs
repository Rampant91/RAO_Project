...
{
    public class Form_56VM : BaseFormVM
    {
        public override string FormType => "5.6";

        #region Constructors

        public Form_56VM() { }

        public Form_56VM(Report report) : base(report) { }

        public Form_56VM(in Reports reps)
        {
        ...
        public ICommand GenerateForm56 => new GenerateForm56AsyncCommand(this);
        public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows56);
