...
public class Form_212VM : BaseFormVM
{
    public override string FormType => "2.12";

    #region Constructors

    public Form_212VM() { }

    public Form_212VM(Report report) : base(report) { }

    public Form_212VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows212);
