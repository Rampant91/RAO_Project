...
{
    public class Form_30VM : BaseVM, INotifyPropertyChanged
    {
        #region Storages
        ...
        public string FormType { get; set; } = "3.0";
        ...
        public Form_30VM(in DBObservable reps)
        {
            Storage = new Report { FormNum_DB = "3.0" };

            var ty1 = (Form30)FormCreator.Create("3.0");
            ty1.NumberInOrder_DB = 1;
            var ty2 = (Form30)FormCreator.Create("3.0");
            ty2.NumberInOrder_DB = 2;
            Storage.Rows30.Add(ty1);
            Storage.Rows30.Add(ty2);
            DBO = reps;
        }

        public Form_30VM(string formNum, in Report rep)
        {
            if (rep.FormNum_DB is "1.0" or "2.0" or "3.0")
            {
                Storage = rep;
            }
