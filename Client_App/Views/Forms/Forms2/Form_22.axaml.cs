...
public partial class Form_22 : BaseWindow<Form_22VM>
{
    private readonly Form_22VM _vm = null!;
    ...
    private void InitializeComponent()
    {
        ...
        FormWindowNames.SetWindowKey(this, nameof(Form_22));
    ...
    {
        var command = new NewCopyExecutorDataAsyncCommand((Form_22VM)DataContext);
    ...
    {
        if (DataContext is not Form_22VM vm) return;
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������� �����������.</returns>
    private async Task CheckPeriod(Form_22VM vm)
    {
    ...
    /// <param name="vm">������ ��������� ������.</param>
    /// <returns>��������� � ������������ ������� ������ �������.</returns>
    private async Task RemoveEmptyForms(Form_22VM vm)
    {
        var desktop = (Application.Current?.ApplicationLifetime as IClassicDesktopStyleApplicationLifetime)!;
