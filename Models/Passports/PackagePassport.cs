...
namespace Models.Passports
{
    public class PackagePassport
    {
        ...
        List<CharacteristicOfContentRaoPackage> ContentCharacteristics = new List<CharacteristicOfContentRaoPackage>();
    ...
    public class CharacteristicOfContentRaoPackage
    {
