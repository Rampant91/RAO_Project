...
public class Form_211VM : BaseFormVM
{
    ...
    public Form_211VM(Report report) : base(report) { }

    public Form_211VM(in Reports reps)
    {
    ...
    public ICommand PasteRows => new NewPasteRowsAsyncCommand(this.Report.Rows211);
