...
namespace Models.DBRealization.Migrations.DataModel
{
    ...
    [Migration("20260818095209_AddForms3")]
    partial class AddForms3
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form31.ExportedZriOziiiInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<string>("RadionuclidComposition")
                        .HasMaxLength(64)
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form31.Form31", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form32.ContainerInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<double?>("DepletedUraniumMass")
                        .HasColumnType("DOUBLE PRECISION");
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form32.ExportedZriInfo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<string>("ActivityOnRealeseDate")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
                    ...
                    b.Property<DateOnly?>("CertificateExpirationDate")
                        .HasColumnType("DATE");
                    ...
                    b.Property<string>("ManufacturerOksm")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");

                    b.Property<string>("NuclearMaterials")
                        .HasMaxLength(64)
                        .HasColumnType("varchar(64)");
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form32.Form32", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
                    ...
                    b.Property<bool>("IsRaoRecycling_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRaoStoring_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRaoTransportation_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRvExploitation_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRvProduction_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRvRecycling_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRvStoring_DB")
                        .HasColumnType("BOOLEAN");

                    b.Property<bool>("IsRvTransportation_DB")
                        .HasColumnType("BOOLEAN");
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form32.Identificator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER")
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form31.ExportedZriOziiiInfo", b =>
                {
                    b.HasOne("Models.Forms.Form3.Form31.Form31", "Form31")
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form31.Form31", b =>
                {
                    b.HasOne("Models.Collections.Report", "Report")
                        .WithOne("Rows31One")
                        .HasForeignKey("Models.Forms.Form3.Form31.Form31", "ReportId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form32.ContainerInfo", b =>
                {
                    b.HasOne("Models.Forms.Form3.Form32.Form32", "Form32")
            ...
            modelBuilder.Entity("Models.Forms.Form3.Form32.Form32", b =>
                {
                    b.HasOne("Models.Collections.Report", "Report")
                        .WithOne("Rows32One")
                        .HasForeignKey("Models.Forms.Form3.Form32.Form32", "ReportId")
                        .OnDelete(DeleteBehavior.Cascade);
