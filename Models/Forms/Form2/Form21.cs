...
namespace Models
{
        ...
        public bool CodeRAOout_Hidden
    {
        ...
        public int ExcelRow(ExcelWorksheet worksheet, int Row,int Column,bool Transpon=true)
        {
            ...
            worksheet.Cells[Row + (Transpon == false ? 6 : 0), Column + (Transpon == true ? 6 : 0)].Value = VolumeIn_DB.Replace(" ","")=="-" || VolumeIn_DB.Replace(" ", "") == "" || VolumeIn_DB.Equals("бeз упаковки")|| VolumeIn_DB.Equals("прим.") ? VolumeIn_DB : Convert.ToDouble(VolumeIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 7 : 0), Column + (Transpon == true ? 7 : 0)].Value = MassIn_DB.Replace(" ", "") == "-" || MassIn_DB.Replace(" ", "") == "" || MassIn_DB.Equals("бeз упаковки")|| MassIn_DB.Equals("прим.") ? MassIn_DB : Convert.ToDouble(MassIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 8 : 0), Column + (Transpon == true ? 8 : 0)].Value = QuantityIn_DB;
            worksheet.Cells[Row + (Transpon == false ? 9 : 0), Column + (Transpon == true ? 9 : 0)].Value = TritiumActivityIn_DB.Replace(" ", "") == "-" || TritiumActivityIn_DB.Replace(" ", "") == "" || TritiumActivityIn_DB.Equals("бeз упаковки")|| TritiumActivityIn_DB.Equals("прим.") ? TritiumActivityIn_DB : Convert.ToDouble(TritiumActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 10 : 0), Column + (Transpon == true ? 10 : 0)].Value = BetaGammaActivityIn_DB.Replace(" ", "") == "-" || BetaGammaActivityIn_DB.Replace(" ", "") == "" || BetaGammaActivityIn_DB.Equals("бeз упаковки")|| BetaGammaActivityIn_DB.Equals("прим.") ? BetaGammaActivityIn_DB : Convert.ToDouble(BetaGammaActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 11 : 0), Column + (Transpon == true ? 11 : 0)].Value = AlphaActivityIn_DB.Replace(" ", "") == "-" || AlphaActivityIn_DB.Replace(" ", "") == "" || AlphaActivityIn_DB.Equals("бeз упаковки")|| AlphaActivityIn_DB.Equals("прим.") ? AlphaActivityIn_DB : Convert.ToDouble(AlphaActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
            worksheet.Cells[Row + (Transpon == false ? 12 : 0), Column + (Transpon == true ? 12 : 0)].Value = TransuraniumActivityIn_DB.Replace(" ", "") == "-" || TransuraniumActivityIn_DB.Replace(" ", "") == "" || TransuraniumActivityIn_DB.Equals("бeз упаковки")|| TransuraniumActivityIn_DB.Equals("прим.") ? TransuraniumActivityIn_DB : Convert.ToDouble(TritiumActivityIn_DB.Replace("е", "E").Replace("(", "").Replace(")", "").Replace("Е", "E").Replace(".", ","));
