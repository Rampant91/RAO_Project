...
public class DataGridDoubleClickBehavior : Behavior<DataGrid>
{
    ...
    private static void OnDataGridDoubleTapped(object sender, RoutedEventArgs e)
    {
        if (e is not TappedEventArgs tappedEvent) return;
    ...
    {
        while (visual != null && visual is not T)
        {
